...
// 데이터 베이스 호스트 이름
#define FIREBASE_HOST "fir-led-control-shin-default-rtdb.firebaseio.com"

// 데이터 베이스 비밀번호
#define FIREBASE_AUTH "WbS6nA7J3HBOZrQScrv4ZYcrfQ0lJcTIWBDKwodh"

// Wi-Fi 설정
#define WIFI_SSID "U+NetFF47"
#define WIFI_PASSWORD "32F8013517"
